...
int		Characters[]=		/*	Each bit represents a segment:	*/
		{	0,								/* space*/
			...
			+64+N(8),
			-1,
			1+2+8+16+32+N(9)+N(7)+N(11),	/*	$	*/
			+N(12)+N(8)+16+2,
			0,
			+N(7),
			+N(8)+N(10),					/*	(	*/
			64+N(12),						/*	)	*/
			+32+64+N(7)+N(8)+N(9)+N(10)+N(11)+N(12),
											/*	*	*/
			32+N(7)+N(9)+N(11),			/*	+	*/
			N(12),							/*	,	*/
			32+N(9),						/*	-	*/
			...
			1+8+16+N(13),					/*	C	*/
			1+2+4+8+N(7)+N(11),				/*	D	*/
			1+8+16+32+N(9)+N(13),			/*	E	*/
			8+16+32+N(9)+N(13),			/*	F	*/
			1+2+8+16+N(9)+N(13),			/*	G	*/
			2+4+16+32+N(9)+N(13),			/*	H	*/
			1+8+N(7)+N(11),					/*	I	*/
			1+2+4+N(13),					/*	J	*/
			16+N(13)+32+N(8)+N(10),		/*	K	*/
			1+16+N(13),						/*	L	*/
			2+4+16+N(13)+64+N(8),			/*	M	*/
			2+4+16+N(13)+64+N(10),		/*	N	*/
			1+2+4+8+16+N(13),				/*	O	*/
			4+8+16+N(13)+32+N(9),			/*	P	*/
			1+2+4+8+16+N(13)+N(10),			/*	Q	*/
			4+8+16+N(13)+32+N(9)+N(10),	/*	R	*/
			1+2+8+16+32+N(9),				/*	S	*/
			8+N(11)+N(7),					/*	T	*/
			1+2+4+16+N(13),					/*	U	*/
			16+N(13)+N(12)+N(8),			/*	V	*/
...
#else
  int thePat=0;
  int theScale=VA.segmscale*2;
  int halfScale=theScale/2;
...
register	long	a,b;
{
  ...
  /*RGBColor c;*/
    ...
    TextSize(18);
    NICK_MOVETO(VA.CurrentX,VA.CurrentY+30);  DrawText(p,a,b);
#endif
	/*SwapMMUMode(&mode);*/
}
