...
extern int AddShot(int lane);
extern int ShotHitTest(int lane,int level);
extern void DrawStaticPlayer(int cx,int cy,int dx,int dy);
extern void DrawPlayer(int cx,int cy,int dx,int dy,int slant);
extern void BlowUpPlayer(int cx,int cy,int dx,int dy,int slant);
