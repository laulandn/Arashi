...
extern void RedrawSpikes(void);
extern void RedrawField(void);
extern void SetItemEnable(DialogPtr dialog,int num,int value);
extern void SetItemValue(DialogPtr dialog,int num,int value);
extern void CenterWindow(DialogPtr dialog);
