/*/
     ...
     Last modification: Thursday, January 13, 1994, 8:26
     Created: Wednesday, March 6, 1991, 12:00

     Copyright © 1991-1994, Juri Munkki
/*/
...
extern void LoadGameF(void);
extern short STLoadForSelect(int restartmode);
...
#define	ADVERTISE
		...
		{	unsigned
			...
			char	*funtext=(void *)"\p ARASHI *** Copyright 1991-1994 Project STORM Team, All Rights Reserved *** Version 1.1.1 *** Please select your starting level ***";
